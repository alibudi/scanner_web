...
<nav class="navbar navbar-dark bg-success navbar-expand fixed-bottom d-md-none d-lg-none d-xl-none">
    <ul class="navbar-nav nav-justified w-100">
        <li class="nav-item">
            <a href="<?php echo base_url('home')?>" class="nav-link text-center">
...
<div class="btn-group">
  ...
  <div class="dropdown-menu">
    ...
    <a class="dropdown-item" href="#">Ambil Snack</a>
  </div>
</div>
 </div>
...
<div style="margin: 10px" class="login-box-msg">
  <a href="<?php echo base_url('home/scan') ?>" class="btn btn-primary btn-block btn-flat">Lanjut</a><br>
  </div>
</div>
